...
\begin{center}
	\fbox{
		\parbox{.9\textwidth}{\textbf{NOTA}: La biblioteca ANTLR \emph{runtime} debe estar en el sistema o incluir el \texttt{.jar} en el proyecto para ejecutar el programa.}
	}	
\end{center}
...
\lstinputlisting[float,style=consola,caption={Ejemplo de archivo \texttt{.classpath}.},label=classpath]{classpath}
...
\lstinputlisting[float,style=editor,caption={Ejemplo de archivo \texttt{.g4}.},label=id_g4]{id.g4}
