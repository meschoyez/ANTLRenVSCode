...
\lstinputlisting[float,style=miJSON,caption={Ejemplo de archivo \texttt{settings.json}.},label=settings]{settings.json}
...
\lstinputlisting[float,style=miXML,caption={Ejemplo de archivo \texttt{.classpath}.},label=classpath]{classpath}
...
\lstinputlisting[float,style=miJSON,caption={Entrada en archivo \texttt{settings.json} para ANTLR.},label=launch_json_antlr]{launchJsonAntlr.json}
...
% ,style=editor
\lstinputlisting[float,style=miANTLR,caption={Ejemplo de archivo \texttt{.g4}.},label=id_g4]{id.g4}
